...
%type <exp> exp program funcall rec_creation exp_or exp_or_rec exp_and exp_and_rec exp_compa exp_add exp_add_rec exp_mul exp_mul_rec exp_nega exp_seq factor case
%type <var> lvalue
...
case: CASE COLON exp case     { $$ = A_CaseExp(EM_tokPos, $3, $4, NULL);}
